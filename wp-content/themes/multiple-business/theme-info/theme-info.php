...
$config = array(
    ...
    'tabs' => array(
        ...
        'recommended_actions'  => __( 'Recommended Actions', 'multiple-business' ),
    ...
    'recommended_actions'        => array(
        'creative-blocks' => array(
            'title' => esc_html__( 'Install Creative Blocks','multiple-business' ),
            'desc' => sprintf( esc_html__( 'The Creative Blocks, an elegant professional page building blocks for the WordPress Gutenberg block editor', 'multiple-business' ) ),
            'id' => 'creative-blocks',
    ...
    'faq'      => array(
        'first' => array (
            ...
            'desc' => esc_html__( 'Multiple Business supports Creative Blocks, WooCommerce, Contact From 7 and MailChimp for WordPress.','multiple-business' ),
            'is_new_tab' => true
        ),
    ),
    // Support content tab.
